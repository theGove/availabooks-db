...
::: {.ai-conversation prompt="Write a SQL statement to list the artists and their style whose style includes the word \"classic\"."}
...
::: {.ai-conversation prompt="Write an SQL statement to list the artists and their style whose style starts with the word \"art\"."}
...
::: {.ai-conversation prompt="Write an SQL statement to list the artists and their style whose style ends with the word \"art\"."}
...
::: {.ai-conversation prompt="Write an SQL statement to list the artists and their style whose style contains the word \"art\"."}
...
::: {.ai-conversation prompt="Write an SQL statement to list the artists and their style whose style starts with \"a\" and ends with \"t\"."}
...
::: {.ai-conversation prompt="Write an SQL statement to list the artists whose last name starts with the letters 'mo', has any third character, and ends with the letters 'et'."}
...
::: {.ai-conversation prompt="Write an SQL statement to list the artists whose last name contains the letter 'n' as the third letter."}
...
::: {.ai-conversation prompt="Write a SQL statement to list the artists whose last name starts with the letter a or b using PostgreSQL's SIMILAR TO operator."}
