...
> **Note.** Used to highlight interesting information that is related to the content presented in the lesson.

> **Tip.** Used to highlight a suggested best practice or easier way to do things.

> **Term** — Used to highlight a glossary term and its definition. Unlike the other sidebars on this list, a term sidebar has no label of its own; instead it's presented as the bolded term followed by an em dash and its definition, exactly as it is here.

> **Caution.** Used to highlight common mistakes or issues encountered by SQL programmers.

> **Objectives.** Used to highlight the learning objectives of the lesson.

> **Review.** Used to highlight information that was presented in a prior lesson that is relevant to the current topic.
